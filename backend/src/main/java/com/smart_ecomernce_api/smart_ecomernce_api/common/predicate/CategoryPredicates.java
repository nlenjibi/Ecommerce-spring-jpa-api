...
public class CategoryPredicates {
    ...
    /**
     * Filter by any text (name or description)
     */
    public CategoryPredicates withTextContaining(String keyword) {
        if (keyword != null && !keyword.isEmpty()) {
            builder.and(
                Expressions.stringPath("name").containsIgnoreCase(keyword)
                    .or(Expressions.stringPath(FIELD_DESCRIPTION).containsIgnoreCase(keyword))
            );
        }
        return this;
    }
     ...
     */
    public CategoryPredicates withSlug(String slug) {
        if (slug != null && !slug.isEmpty()) {
            builder.and(Expressions.stringPath("slug")
     ...
     */
    public CategoryPredicates withParentId(Long parentId) {
        if (parentId != null) {
            builder.and(Expressions.numberPath(Long.class, FIELD_PARENT + ".id").eq(parentId));
        }
        return this;
    }
    ...
    /**
     * Filter by meta keywords containing
     */
    public CategoryPredicates withMetaKeywordsContaining(String keyword) {
        if (keyword != null && !keyword.isEmpty()) {
            builder.and(Expressions.stringPath("metaKeywords")
    ...
    /**
     * Filter by path/URL pattern
     */
    public CategoryPredicates withPathStartingWith(String path) {
        if (path != null && !path.isEmpty()) {
            builder.and(Expressions.stringPath("path").startsWith(path));
        }
        return this;
    }
    ...
    /**
     * Filter by parent name containing
     */
    public CategoryPredicates withParentNameContaining(String parentName) {
        if (parentName != null && !parentName.isEmpty()) {
            builder.and(Expressions.path(Object.class, FIELD_PARENT).isNotNull()
                .and(Expressions.stringPath("parent.name")
                    .containsIgnoreCase(parentName)));
        }
        return this;
    }
