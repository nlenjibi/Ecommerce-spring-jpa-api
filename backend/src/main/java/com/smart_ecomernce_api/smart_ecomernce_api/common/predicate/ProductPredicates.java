...
public class ProductPredicates {
    ...
    public ProductPredicates withDescriptionContaining(String description) {
        if (description != null && !description.isEmpty()) {
            builder.and(Expressions.stringPath("description").containsIgnoreCase(description));
        }
        return this;
    }
    ...
    public ProductPredicates withRatingGreaterThanOrEqual(Double minRating) {
        if (minRating != null) {
            builder.and(Expressions.numberPath(Double.class, "ratingAverage").goe(minRating));
        }
        return this;
    }
